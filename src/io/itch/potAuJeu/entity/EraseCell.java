...
public class EraseCell extends CellEntity
{

	public EraseCell(int cellX, int cellY, GridEntity parent, int x, int y, int width, int height, int backgroundOriginalWidth, int backgroundOriginalHeight)
	{
		super(cellX, cellY, parent, AssetsManager.getImage("erase_" + parent.getGridSize() + "x" + parent.getGridSize()), x, y, width, height, backgroundOriginalWidth, backgroundOriginalHeight);
	}
